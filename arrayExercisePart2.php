...
<body>
	<h4>Write a PHP script to count a total number of duplicate elements in an array. </h4>
<?php
...
<h4>Write a PHP script to count the frequency of each element of an array.</h4>
<?php
...
for( $i = 0; $i < count($fr); $i++)
{
	...
	<h4>Write a PHP script to separate odd and even integers in separate arrays. </h4>
<?php
